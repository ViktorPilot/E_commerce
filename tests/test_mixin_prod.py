...
def test_product_mixin_1(capsys, product_casio: Product) -> None:
...
def test_smartphone_mixin_2(capsys, smartphone_1: Smartphone) -> None:
...
def test_grass_mixin_3(capsys, grass_1: LawnGrass) -> None:
